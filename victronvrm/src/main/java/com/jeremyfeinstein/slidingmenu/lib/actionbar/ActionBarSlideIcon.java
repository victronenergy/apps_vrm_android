...
public class ActionBarSlideIcon {
	 ...
	 *            The activity
	 * @param slideDrawable
	 *            The {@link android.graphics.drawable.Drawable} that can slide
	...
	/**
	 * Get the {@link android.graphics.drawable.Drawable} that will slide
	 *
	 * @return
	 */
	...
	/**
	 * Set the {@link android.graphics.drawable.Drawable} of the ActionBar
	 *
	 * @param drawable
	 */
