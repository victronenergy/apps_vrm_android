...
<html>
  ...
  /* ]]> */
      ...
      <style type='text/css'>
         ...
         #bug-summary, #analysis-data, #list-by-category, #list-by-package {
            font-family: Monaco;
         }
         #analysis-data ul {
            margin-left: 15px;
         ...
         .ob-t {
            border-bottom: 1px solid #000000; font-size: 10pt; font-weight: bold;
         ...
         .ib-1-t, .ib-2-t {
            ...
            font-size: 9pt; font-weight: bold; background: #cccccc;
         }
         .bb {
            border-bottom: 1px solid #000000; border-left: 1px solid #000000;
         }
         .b-1 {
            background: #ffaaaa; height: 0.5em; width: 1em;
            margin-right: 0.5em;
         }
         .b-2 {
            background: #ffddaa; height: 0.5em; width: 1em;
            margin-right: 0.5em;
         }
         .b-3 {
            background: #aaffaa; height: 0.5em; width: 1em;
            margin-right: 0.5em;
         }
         .b-4 {
            background: #aaaaff; height: 0.5em; width: 1em;
            margin-right: 0.5em;
         }
         .b-t {
         }
         .b-r {
            font-size: 9pt; font-weight: bold; padding: 0 0 0 60px;
         }
         .b-d {
